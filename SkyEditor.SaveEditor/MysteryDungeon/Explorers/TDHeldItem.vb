...
Namespace MysteryDungeon.Explorers
    Public Class TDHeldItem
        ...
        Public Shared Function FromHeldItemBits(bits As Binary) As TDHeldItem
            Dim out As New TDHeldItem
            With bits
                out.IsValid = .Bit(0)
                out.Flag1 = .Bit(1)
                ...
                Dim parameter = .Int(0, 7, 11)
                out.ID = .Int(0, 18, 10)
                out.HeldBy = .Int(0, 28, 3)
                If out.IsBox Then
